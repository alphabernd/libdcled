...
var stdfont = map[rune][]Point{
	...
	'm': []Point{Point{1, 2}, Point{1, 3}, Point{1, 4}, Point{1, 5}, Point{1, 6}, Point{1, 7}, Point{2, 3}, Point{3, 3}, Point{3, 4}, Point{3, 5}, Point{3, 6}, Point{3, 7}, Point{4, 3}, Point{5, 3}, Point{5, 4}, Point{5, 5}, Point{5, 6}, Point{5, 7}},
	'n': []Point{Point{1, 2}, Point{1, 3}, Point{1, 4}, Point{1, 5}, Point{1, 6}, Point{1, 7}, Point{2, 3}, Point{3, 3}, Point{3, 4}, Point{3, 5}, Point{3, 6}, Point{3, 7}},
	'o': []Point{Point{1, 4}, Point{1, 5}, Point{1, 6}, Point{2, 3}, Point{2, 7}, Point{3, 3}, Point{3, 7}, Point{4, 4}, Point{4, 5}, Point{4, 6}},
